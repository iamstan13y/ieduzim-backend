...
{
    public class PaymentsService:BaseService<Payments>
    {
        
        public Paginator<Payments> GetPagedByUser(PageRequest request, string userId)
        {
            ...
            return new Paginator<Payments>(request, total, req);
        }
